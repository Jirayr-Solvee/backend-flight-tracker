...
<body>
  <main>
    ...
    <p class="subtitle">Luma Tales - Last updated: August 24, 2026</p>
    ...
    <p>For one-time video pack purchases, we process product identifiers, purchase status, remaining video credits, and Apple transaction information needed to grant purchased credits. Apple handles payment details. We do not see or store credit card numbers.</p>
    <p>For analytics and attribution, we may collect app opens, onboarding and paywall views, purchase events, cartoon generation status, selected template identifiers, product interaction events, device or installation identifiers, and advertising attribution information. If you allow tracking on iOS, Apple's advertising identifier may be used to measure which ads brought you to Luma Tales.</p>

    <h2>2. How We Use Information</h2>
    <p>We use cartoon inputs to generate personalized videos and sound; save cartoons in your library; grant and use video credits; improve app reliability; understand app performance; and measure the effectiveness of our advertising campaigns.</p>
    ...
    <ul>
      ...
      <li><strong>Apple StoreKit</strong> for one-time consumable video pack purchases.</li>
    ...
    <p>Luma Tales does not display third-party ads in the app. We may use AppsFlyer to understand which marketing campaigns lead to installs, purchases, and app engagement.</p>
    ...
    <p>You can restore eligible purchases from the app. Consumable video credits are one-time purchases and do not renew automatically. You can request deletion of backend data associated with your anonymous account by contacting us.</p>

    <h2>8. Data Sharing</h2>
    <p>We do not sell personal information. We share information with service providers only as needed to operate the app, generate cartoons, process one-time purchases, measure app performance, and measure advertising effectiveness as described in this policy.</p>
...
LUMA_SUPPORT_HTML = """<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Support - Luma Tales</title>
  <style>
    body {
      font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
      line-height: 1.7;
    ...
    .subtitle { color: #666; margin: 0 0 36px; }
    a { color: #5d3df5; }
  </style>
</head>
<body>
  <main>
    <h1>Luma Tales Support</h1>
    <p class="subtitle">Personalized cartoons for families</p>

    <h2>Contact us</h2>
    <p>For help with Luma Tales, email
      <a href="mailto:jirayr.melikyan.jm@gmail.com">jirayr.melikyan.jm@gmail.com</a>.
      Please describe what happened and include your iPhone model and iOS version. Do not send sensitive information about your child.</p>

    <h2>Cartoon generation</h2>
    <p>A personalized cartoon usually takes a few minutes to generate. Keep the app installed and connected to the internet. If generation fails, reopen the app and check the Library before trying again.</p>

    <h2>Video packs</h2>
    <p>Luma Tales uses one-time consumable video packs, not subscriptions. One credit creates one new cartoon or one continuation. Purchases are handled by Apple. If a purchase completes but credits do not appear, use Restore Purchases in the app or contact us with the Apple transaction date.</p>

    <h2>Privacy and deletion</h2>
    <p>Read the <a href="/luma/privacy">Luma Tales Privacy Policy</a>. You may also email us to request deletion of data associated with your anonymous app account.</p>
  </main>
</body>
</html>
"""
...
@router.api_route(
    "/luma/support", methods=["GET", "HEAD"], response_class=HTMLResponse
)
def luma_support() -> str:
    return LUMA_SUPPORT_HTML


@router.api_route(
    "/luma/support.html", methods=["GET", "HEAD"], response_class=HTMLResponse
)
def luma_support_html() -> str:
    return LUMA_SUPPORT_HTML
